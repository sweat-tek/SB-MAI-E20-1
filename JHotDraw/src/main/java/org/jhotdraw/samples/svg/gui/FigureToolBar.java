...
//
//                // Opacity slider
//                JPopupButton opacityPopupButton = setUpOpacityPopupButton();
...
//                JAttributeTextField<Double> opacityField = createOpacityField();
//                gbc = new GridBagConstraints();
//                gbc.gridx = 1;
//                gbc.gridy = 0;
////                gbc.insets = new Insets(0, 0, 0, 0);
...
//    }
    ...
    private JPanel createStandardJPanel() {
        JPanel p = new JPanel();
        p.setOpaque(false);
        p.setLayout(new GridBagLayout());
        p.setBorder(new EmptyBorder(5, 5, 5, 8));
    ...
    private JAttributeSlider setupOpacitySlider() {
    ...
    private JPopupButton setUpOpacityPopupButton() {
    ...
    private void setSelectionIcon(JPopupButton opacityPopupButton) {
        opacityPopupButton.setIcon(
                new SelectionOpacityIcon(editor, OPACITY, FILL_COLOR, STROKE_COLOR, getClass().getResource(labels.getString("attribute.figureOpacity.icon")),
                        new Rectangle(5, 5, 6, 6), new Rectangle(4, 4, 7, 7)));
    }
