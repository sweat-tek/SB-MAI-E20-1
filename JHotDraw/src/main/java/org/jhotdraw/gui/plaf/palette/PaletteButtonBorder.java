...
public class PaletteButtonBorder implements Border, UIResource {
    ...
    public void paintBorder(AbstractButton c, Graphics gr, int x, int y, int width, int height) {
        ...
        g.setPaint(CreateBorderPaint(x, y, height, stops, stopColors));
    ...
    private LinearGradientPaint CreateBorderPaint(int x, int y, int height, float[] stops, Color[] stopColors){
