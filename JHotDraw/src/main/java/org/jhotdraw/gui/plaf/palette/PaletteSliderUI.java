...
public class PaletteSliderUI extends BasicSliderUI
{
    ...
    private final static float[] enabledStops = new float[]
    {
        0f, 0.35f, 0.35f, 1f
    };
    ...
    private final static float[] disabledStops = new float[]
    {
        0f, 0.35f, 0.35f, 1f
    };
    private final static Color[] disabledStopColors = new Color[]
    {
        new Color(0xf3f3f3), new Color(0xeeeeee), new Color(0xcacaca), new Color(0xf3f3f3)
    };
    private final static float[] selectedStops = new float[]
    {
        0f, 0.2f, 1f
    };
    private final static Color[] selectedStopColors = new Color[]
    {
        new Color(0x999999), new Color(0xaaaaaa), new Color(0x666666)
    };
    ...
    public void paintThumb(Graphics gr)
    {
        ...
        {
            drawHorizontalSlider(w, g, h);
        } else
        {  // vertical
            if (slider.getComponentOrientation().isLeftToRight())
            {
                drawLeftToRightSlider(g, w, h);
            } else
            {
                drawRightToLeftSlider(g, w, h);
            }
        }
    ...
    private void drawRightToLeftSlider(Graphics2D g, int w, int h)
    {
        int cw = h / 2;
    ...
    private void drawLeftToRightSlider(Graphics2D g, int w, int h)
    {
        int cw = h / 2;
    ...
    private void drawHorizontalSlider(int w, Graphics2D g, int h)
    {
        int cw = w / 2;
